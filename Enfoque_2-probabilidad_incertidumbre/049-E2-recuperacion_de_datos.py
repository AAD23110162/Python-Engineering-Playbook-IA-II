...
class IndiceTFIDF:
	def __init__(self):
		self.doc_tokens = []   # lista de listas de tokens
		self.df = Counter()    # document frequency
		self.idf = defaultdict(float)
		self.tfidf_doc = []    # lista de vectores TF-IDF por doc (Counter)
		self.N = 0
	...
	def construir(self, documentos):
		...
		# DF: número de docs que contienen cada término
